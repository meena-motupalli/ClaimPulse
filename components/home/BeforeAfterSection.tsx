  ...
  return (
    <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6 text-left">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-[#FFFFFF] border border-[#A33A3A]/30 rounded-lg p-6 space-y-4 shadow-2xs">
          <div className="flex items-center gap-2.5 pb-3 border-b border-[#A33A3A]/20">
            ...
            <div>
              <h3 className="text-base font-bold text-[#432F28]">Existing Citizen Experience</h3>
          ...
          <div className="space-y-2 text-xs">
            {[
              ...
              <div key={idx} className="p-3 bg-[#A33A3A]/5 rounded border border-[#A33A3A]/20 text-[#262321] space-y-0.5">
                <div className="font-bold text-[#A33A3A] text-xs">
                  {idx + 1}. {step.title}
                </div>
                <p className="text-[11px] text-[#6B625D] leading-relaxed">{step.desc}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="bg-[#FFFFFF] border border-[#26734A]/30 rounded-lg p-6 space-y-4 shadow-2xs">
          <div className="flex items-center gap-2.5 pb-3 border-b border-[#26734A]/20">
            <div className="w-8 h-8 rounded bg-[#26734A] text-white flex items-center justify-center shrink-0 shadow-2xs">
              <CheckCircle2 className="w-5 h-5" />
            </div>
            <div>
              <h3 className="text-base font-bold text-[#432F28]">ClaimPulse Experience</h3>
              <p className="text-[11px] text-[#26734A] font-bold">Structured Citizen Guidance</p>
            </div>
          </div>
          ...
          <div className="space-y-2 text-xs">
            {[
              ...
              <div key={idx} className="p-3 bg-[#26734A]/5 rounded border border-[#26734A]/20 text-[#262321] space-y-0.5">
                <div className="font-bold text-[#26734A] text-xs">
                  {idx + 1}. {step.title}
                </div>
                <p className="text-[11px] text-[#6B625D] leading-relaxed">{step.desc}</p>
              </div>
